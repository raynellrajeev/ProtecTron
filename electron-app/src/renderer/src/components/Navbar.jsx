...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed w-full h-auto flex justify-between p-3 items-center z-50 backdrop-blur-3xl">
        <Link to="/Home">
          <div className="logo-container-header w-32 ml-3">
            <img
              className="logo-image hover:box-shadow-[0_0_15px_rgba(255,255,255,0.8)]"
              src={Logo}
              alt="ProtecTron"
            />
          </div>
