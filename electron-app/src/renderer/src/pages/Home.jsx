    ...
    return (
        <div className='h-screen'>
            ...
            <div className="grid grid-cols-6 grid-rows-4 gap-4 border-0 bg-transparent pt-24 p-12 h-full w-full max-w-screen max-h-screen-lg min-h-screen overflow-hidden">
                    ...
                    <div className='p-2flex flex-col justify-center w-full'>
                        <div className='flex gap-2 items-center px-[5%]'>
                            <h1 className="text-[min(2.5vw,1.875rem)] font-bold text-white">
                                Protection Status: 
                                <span className='text-[min(3vw,2.25rem)] font-bold text-[#008000] pl-2'>
                                    safe
                                </span>
                            </h1>
                        </div>
                        <p className='text-[min(1.5vw,1rem)] pt-2 px-[5%]'>Last scanned : 02-02-2025</p>
                ...
                <div className='col-span-4 row-start-2 row-span-3 border-2 rounded-2xl flex items-center justify-center bg-neutral-800/30 border-white/25 p-4'>
                    <Stack
                        direction={'column'}
